...
// Generated on: Aug  5 2024 11:52:03
...
module wptr_handler_PTR_WIDTH10(wclk, wrst_n, w_en, g_rptr_sync,
  ...
  wire n_26, n_37, n_40, n_67, n_68, wfull;
  ksa_adder_data_size10 adder(.a (b_wptr[9:0]), .b ({9'b000000000,
       n_37}), .cin (1'b0), .sum (b_wptr_next[9:0]), .cout
       (UNCONNECTED29));
  equal_unsigned eq_34_31(.A ({b_wptr_next[10], g_wptr_next[9:0]}), .B
       ({n_68, n_67, g_rptr_sync[8:0]}), .Z (wfull));
  bmux_2 mux_full_30_8(.ctl (n_26), .in_0 (wfull), .in_1 (1'b0), .z
       (UNCONNECTED30));
  bmux mux_g_wptr_19_8(.ctl (n_26), .in_0 ({b_wptr_next[10],
       g_wptr_next[9:0]}), .in_1 (11'b00000000000), .z ({UNCONNECTED41,
  ...
  bmux mux_b_wptr_19_8(.ctl (n_26), .in_0 (b_wptr_next), .in_1
       (11'b00000000000), .z ({UNCONNECTED52, UNCONNECTED51,
       UNCONNECTED50, UNCONNECTED49, UNCONNECTED48, UNCONNECTED47,
       UNCONNECTED46, UNCONNECTED45, UNCONNECTED44, UNCONNECTED43,
       UNCONNECTED42}));
  and g2 (n_37, w_en, n_40);
  not g1 (n_40, full);
  ...
  CDN_flop \b_wptr_reg[0] (.clk (wclk), .d (b_wptr_next[0]), .sena
       (1'b1), .aclr (n_26), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q
       (b_wptr[0]));
  ...
  CDN_flop full_reg(.clk (wclk), .d (wfull), .sena (1'b1), .aclr
       (n_26), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q (full));
  not g28 (n_68, g_rptr_sync[10]);
  not g29 (n_67, g_rptr_sync[9]);
endmodule
...
module rptr_handler_PTR_WIDTH10(rclk, rrst_n, r_en, g_wptr_sync,
  ...
  wire n_26, n_37, n_40, rempty;
  ksa_adder_data_size10 adder(.a (b_rptr[9:0]), .b ({9'b000000000,
       n_37}), .cin (1'b0), .sum (b_rptr_next[9:0]), .cout
       (UNCONNECTED53));
  equal_unsigned eq_19_32(.A (g_wptr_sync), .B ({b_rptr_next[10],
       g_rptr_next[9:0]}), .Z (rempty));
  bmux_2 mux_empty_34_8(.ctl (n_26), .in_0 (rempty), .in_1 (1'b1), .z
       (UNCONNECTED54));
  bmux mux_g_rptr_23_8(.ctl (n_26), .in_0 ({b_rptr_next[10],
       g_rptr_next[9:0]}), .in_1 (11'b00000000000), .z ({UNCONNECTED65,
  ...
  bmux mux_b_rptr_23_8(.ctl (n_26), .in_0 (b_rptr_next), .in_1
       (11'b00000000000), .z ({UNCONNECTED76, UNCONNECTED75,
       UNCONNECTED74, UNCONNECTED73, UNCONNECTED72, UNCONNECTED71,
       UNCONNECTED70, UNCONNECTED69, UNCONNECTED68, UNCONNECTED67,
       UNCONNECTED66}));
  and g2 (n_37, r_en, n_40);
  not g1 (n_40, empty);
  ...
  CDN_flop empty_reg(.clk (rclk), .d (rempty), .sena (1'b1), .aclr
       (1'b0), .apre (n_26), .srl (1'b0), .srd (1'b0), .q (empty));
endmodule
...
module fifo_mem(wclk, w_en, rclk, r_en, waddr, raddr, wdata, full,
  ...
  sky130_sram_1kbyte_1rw1r_8x1024_8 RAM(.din0 (wdata), .addr0 (waddr),
       ...
       (raddr), .csb1 (r_en), .clk1 (rclk), .dout0 ({UNCONNECTED84,
       UNCONNECTED83, UNCONNECTED82, UNCONNECTED81, UNCONNECTED80,
       UNCONNECTED79, UNCONNECTED78, UNCONNECTED77}), .dout1 (rdata));
endmodule
